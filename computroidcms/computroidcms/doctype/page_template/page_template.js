...
frappe.ui.form.on('Page Template', {
...
var add_new_section = Class.extend({
    ...
    margin-bottom: 0;
        ...
        if(me.groups.length>0){
             ...
             group_html+="<ul style='float: left;width: 100%;padding: 0;margin: 0;'><li style='list-style:none;float: left;width: calc(100% + 33px);padding: 10px 15px;border-bottom: 1px solid #ddd;margin-left: -18px;' class='active'><a class='group-link' id='dtgroupAll' style='float: left;width: 100%;text-decoration: none;' onclick=filter_section('All')>All</a></li>";
             for (var i = 0; i < me.groups.length; i++) {
                 group_html+='<li style="list-style:none;float: left;width: calc(100% + 33px);padding: 10px 15px;border-bottom: 1px solid #ddd;margin-left: -18px;"><a class="group-link" style="float: left;width: 100%;text-decoration: none;"';
                 group_html+='data-group="'+me.groups[i].group_name+'" id="dtgroup'+i+'" onclick=filter_section('+i+')>'+me.groups[i].group_name+'</a></li>';
             }
             group_html+="</ul>";
            ...
            item.click(function() {
                if (me.section_type == 'existing') {
                    ...
                    var title_dialog =   new frappe.ui.Dialog({
                            ...
                            // fields: [{ "label": __("Enter Section Title"), "fieldname": "title_name", "fieldtype": "Data" }, { "fieldname": "section_html", "fieldtype": "HTML" }]
                            fields: [{"fieldname": "custom_title", "fieldtype": "Data","label": __("Enter Section Title"),"default":f.name }]
...
var add_page_template = Class.extend({
    ...
    section_html: function() {
        ...
        let data = me.sections ? me.sections : me.templates;
        wrapper.find('#PageList').append("<div class='col-md-12' id='sec-right-content' style='padding-top:20px'></div>");
        data.map(f => {
