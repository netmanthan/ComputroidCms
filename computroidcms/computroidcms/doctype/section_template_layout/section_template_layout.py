...
class SectionTemplateLayout(Document):
	...
	def on_update(self):
		try:
			...
			frappe.log_error(frappe.get_traceback(),"computroidcms.computroidcms.doctype.section_template_layout.section_template_layout.on_update")
...
def get_layout_data():
	try:
		...
		frappe.log_error(frappe.get_traceback(),"computroidcms.computroidcms.doctype.section_template_layout.section_template_layout.get_layout_data")
...
def get_each_layout_data(layout_id,page_route):
	try:
		...
		frappe.log_error(frappe.get_traceback(),"computroidcms.computroidcms.doctype.section_template_layout.section_template_layout.get_each_layout_data")
