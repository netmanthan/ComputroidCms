...
frappe.require("/assets/computroidcms/js/proposal.js");
...
frappe.ui.form.on('Proposal', {
    refresh: function(frm) {
        if(frm.doc.document){
           frm.set_query("data_fetch_from", function() {
            return {
                "query":"computroidcms.computroidcms.doctype.proposal.proposal.get_linked_docs",
                "filters": {
           ...
           frappe.call({
                method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_side_menu_fields',
                args: {
        ...
        if (!frm.__islocal && frm.doc.published==1) {
            ...
            //     window.open(
            //       'https://computroid-cms.web.app/p/'+frm.doc.route,
            ...
            frm.add_custom_button(__('Send Document'), function () {
                ...
                if (frm.doc.preview_pdf_url && frm.doc.quotation) {
                    ...
                    frappe.call({
                        method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_attachement_email_id',
                        args: {
        ...
        frm.add_custom_button(__('Preview PDF'), function () {
                    window.open(
                        window.location.origin + '/api/method/computroidcms.computroidcms.doctype.proposal.proposal.generate_pdf?page='+frm.doc.name+'&&name='+frm.doc.quotation,
                        '_blank' // <- This is what makes it open in a new window.
                        );
               ...
               var title_dialog =   new frappe.ui.Dialog({
                     ...
                     title_dialog.set_primary_action(__('Save As Template'), function() {
                         let val = title_dialog.get_values();
                          frappe.call({
                                method: 'computroidcms.computroidcms.doctype.proposal.proposal.save_as_template',
                                args: {
    ...
    delete_sections: function(frm, name, parentfield) {
        frappe.confirm(
            ...
            function(){
              frappe.call({
                    method: 'computroidcms.computroidcms.doctype.proposal.proposal.delete_section',
                    args: {
                        name: name,
    ...
    edit_styles_sections: function(frm, name, parentfield) {
        var id=name;
        frappe.call({
                method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_section_properties',
                       ...
                       styledialog.set_primary_action(__('Save'), function() {
                           ...
                           for (let k in values) {
                            ...
                            $('[data-fieldname="'+id+'"]').attr("style_json",JSON.stringify(style_json))
                             frappe.call({
                                method: 'computroidcms.computroidcms.doctype.proposal.proposal.update_section_properties',
...
var add_new_section = Class.extend({
    ...
    get_all_sections: function() {
        let me = this;
        frappe.call({
            method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_sections',
            args: {
    ...
    get_section_templates: function() {
        let me = this;
        frappe.call({
            method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_section_templates',
            args: {
                device_type: me.device_type
            },
            async: false,
    ...
    make_dialog: function() {
        ...
        //             }
        //             frappe.call({
        //                 method: 'computroidcms.computroidcms.doctype.proposal.proposal.convert_template_to_section',
        //                 args: {
...
var modify_section_data = Class.extend({
    ...
    get_data_fields: function() {
        let me = this;
         // console.log(me,"me----")
        frappe.call({
            method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_section_content',
            args: {
                section: me.section,
    ...
    get_patterns: function() {
        let patterns = []
        frappe.call({
            method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_patterns_list',
            args: {},
            async: false,
            callback: function(r) {
                if (r.message) {
    ...
    get_blog_category:function(type){
          ...
          if(type=='shuffle'){
              if(is_dynamic_data_val==0 && reference_name_val!=""){
                frappe.call({
                    method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_shuffled_blog_category',
                    args: {
    ...
    get_category_products:function(type){
          ...
          if(type=='shuffle'){
              if(is_dynamic_data_val==0 && reference_name_val!=""){
                frappe.call({
                    method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_shuffled_category_products',
                    args: {
                        category: reference_name_val,
                        no_of_records:no_of_records_val
                    },
    ...
    get_fields_list: function() {
        ...
        if (this.fields.section_type == 'Predefined Section' && !this.fields.dynamic_data && !this.fields.is_login_required) {
            ...
            // frappe.call({
            //     method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_featured_products',
            //     args: {},
            //     async: false,
            //     callback: function(r) {
            //         data = r.message
    ...
    save_data: function() {
        ...
        //     css_design +="}"
            ...
            //     frappe.call({
            //         method: 'computroidcms.computroidcms.doctype.proposal.proposal.generate_css_file',
            //         args: {
        ...
        if (results.length > 0 || me.list_section_data.length > 0) {
            // console.log(results)
            frappe.call({
                method: 'computroidcms.computroidcms.doctype.proposal.proposal.update_section_content',
                args: {
                    docs: results,
    ...
    update_design: function() {
        ...
        if (this.selected_pattern) {
            ...
            frappe.call({
                method: 'computroidcms.computroidcms.doctype.proposal.proposal.update_patterns',
        ...
        if (!section_data || section_data == '')
            ...
            table.find('tbody').append(row);
                    ...
                    row.find('.btn-danger').click(function() {
                        ...
                        frappe.call({
                            method: 'computroidcms.computroidcms.doctype.proposal.proposal.update_featured_item',
                            args: {
                                doctype: me.fields.reference_document,
                                name: val.preitem,
                                checked: 1,
    ...
    get_random_records: function(dt, records) {
        let me = this;
        frappe.call({
            method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_random_records',
            args: {
                dt: dt,
                records: records,
                business: cur_frm.doc.business
    ...
    get_predefined_records: function(name, dt, no_of_records, business) {
        let me = this;
        frappe.call({
            method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_predefined_records',
            args: {
                dt: dt,
    ...
    get_collections_records: function(collections) {
        let me = this;
        frappe.call({
            method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_collection_records',
            args: {
    ...
    get_image_album: function(dt, dn) {
        let me = this;
        frappe.call({
            method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_image_album',
            args: {
                dt: dt,
                dn: dn,
                business: cur_frm.doc.business
    ...
    upload_component: function(target, progress) {
        ...
        var uppy = Uppy.Core({
            ...
            .use(Uppy.XHRUpload, {
                endpoint: window.location.origin + '/api/method/computroidcms.computroidcms.doctype.proposal.proposal.upload_img',
                method: 'post',
                formData: true,
                fieldname: 'file',
                headers: {
...
var add_page_template = Class.extend({
    ...
    get_page_templates: function() {
        let me = this;
        frappe.call({
            method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_page_templates',
            args: {
            ...
            item.click(function() {
                if(cur_frm.doc.page_title!="" && cur_frm.doc.page_title!=undefined){
                    ...
                    frappe.confirm('Are you sure you want to proceed?',
                        () => {
                             frappe.call({
                                    method: 'computroidcms.computroidcms.doctype.proposal.proposal.import_sections_from_template',
                                    args: {
...
var add_list_template = Class.extend({
    ...
    get_page_templates: function() {
        let me = this;
        frappe.call({
            method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_list_page_templates',
            args: {
            },
            async: false,
            callback: function(r) {
...
var columns_mapping = Class.extend({
    ...
    get_section_columns: function() {
        let me = this;
        frappe.call({
            method: 'computroidcms.computroidcms.doctype.proposal.proposal.get_section_columns',
            args: {
