...
frappe.ui.form.on('Web Theme', {
	...
	pick_color_palette(frm){
		frappe.call({
			method:"computroidcms.computroidcms.doctype.web_theme.web_theme.get_color_palette_datas",
			args:{},
			freeze:true,
			callback:(res) =>{
	...
	update_default_values(frm,res){
		frappe.call({
			method:"computroidcms.computroidcms.doctype.web_theme.web_theme.get_color_palette_default_datas",
...
frappe.ui.form.on('Typography Heading', {
	...
	edit_styles(frm,cdt,cdn){
		...
		if(item.type){
			frappe.call({
				method:"computroidcms.computroidcms.doctype.web_theme.web_theme.get_json_render_properties",
